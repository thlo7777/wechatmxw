...
var FormForm = (function($) {
    return function(dom, fields) {
        ...
        self.templates= {
            group: _.template(
            '<div class="form-group <%= data.field.fgClass %>">\
            ...
            selectmultiple: _.template(
                ...
                , {variable: 'data'}),
            input: _.template(
                '<input type="<%= data.type %>" name="<%= data.name %>" class="form-control" id="<%= data.id %>" <% if (data.placeholder ) { %> placeholder="<%= data.placeholder %>" <% }%> <% if (data.value){ %>value="<%- data.value %>"<% } %>/>'
                , {variable: 'data'}),
            textarea: _.template(
            ...
            anchorpicbtn: _.template(
                    '<a href="javascript:void(0)" class="btn btn-primary btn-sm <%= data.class %>">\
        ...
        self.typeConfig = {
            ...
            anchorpicbtn: {
                template: self.templates.anchorpicbtn
            }
        };
